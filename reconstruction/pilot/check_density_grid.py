"""Check voxelize_clusters.generate_density_grid against what clustersim does.
...
against it. Three measurements, recorded in ``reconstruction/ROADMAP.md``
section 3.2:
...
-----
    ...
    PYTHONPATH=. python reconstruction/pilot/check_density_grid.py --patterns 60 \
        --output reconstruction/pilot/results/density_grid.json
"""
...
def main():
    ...
    parser.add_argument("--output", type=Path, default=Path("reconstruction/pilot/results/density_grid.json"))
