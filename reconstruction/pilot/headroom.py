...
it sizes the problem so that the gates in ``reconstruction/ROADMAP.md`` are set
...
Recorded in ``reconstruction/ROADMAP.md`` section 4.

Usage
-----
    PYTHONPATH=. python reconstruction/pilot/headroom.py
    PYTHONPATH=. python reconstruction/pilot/headroom.py --replays 200 --workers 6
"""
...
def main():
    ...
    parser.add_argument("--output", type=Path, default=Path("reconstruction/pilot/results/headroom.json"))
