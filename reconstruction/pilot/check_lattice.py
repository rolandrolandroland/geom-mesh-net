...
Two findings of Stage 0 (``reconstruction/ROADMAP.md`` section 3.2), made
reproducible:
...
Writes ``reconstruction/pilot/results/lattice.json``: per-pattern counts, the
...
def main():
    ...
    parser.add_argument("--lattice-dir", type=Path, default=Path("data"))
    parser.add_argument("--random-dir", type=Path, default=Path("data_random_centres"))
    parser.add_argument("--output", type=Path, default=Path("reconstruction/pilot/results/lattice.json"))
