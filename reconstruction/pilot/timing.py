...
``reconstruction/ROADMAP.md`` (section 4.4).
...
Usage
-----
    PYTHONPATH=. python reconstruction/pilot/timing.py
"""
...
# This environment links two OpenMP runtimes; example_01 sets the same flag.
...
def main():
    ...
    parser.add_argument("--output", type=Path, default=Path("reconstruction/pilot/results/timing.json"))
