...
def transform_k(values, kind):
    ...
    what produced ``experiments/neural_field/methodology_01_results`` and
    ...
    all. See ``experiments/inference/ROADMAP.md`` section 8.3.
...
def _validate_k_radius(k_r_max, side_lengths, context):
    ...
    interior K extremum. See ``experiments/inference/ROADMAP.md`` section 8.4.
    """
