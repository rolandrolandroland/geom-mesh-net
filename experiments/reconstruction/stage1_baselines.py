...
- B0, B1 and B2 (``fields.baselines``) are fitted to the observed atoms, with
...
Gate 1, stated before this ran (``experiments/reconstruction/ROADMAP.md``, Stage 1): at least
...
Usage
-----
    python -m experiments.reconstruction.stage1_baselines
    python -m experiments.reconstruction.stage1_baselines --split development --limit 2 \
...
def main():
    ...
    parser.add_argument("--output", type=Path, default=paths.RECONSTRUCTION_DIR / "results" / "stage1_headroom.json")
