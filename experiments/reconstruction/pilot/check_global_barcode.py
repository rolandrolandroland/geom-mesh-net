...
``statistics.barcode.calculate_spatial_barcode`` to the coordinates, using
...
Recorded in ``experiments/reconstruction/ROADMAP.md`` sections 3.2 and 7.

Usage
-----
    python -m experiments.reconstruction.pilot.check_global_barcode
"""
...
def main():
    ...
    parser.add_argument("--output", type=Path, default=paths.RECONSTRUCTION_DIR / "pilot" / "results" / "global_barcode.json")
