"""Freeze the reconstruction benchmark into experiments/reconstruction/benchmark/ (ROADMAP Stage 0).
...
def main():
    ...
    spec = {
        "data_dir": paths.repo_relative(args.data_dir),
        "lattice_data_dir": paths.repo_relative(bm.LATTICE_DATA_DIR),
        "theta": paths.repo_relative(bm.THETA_PATH),
