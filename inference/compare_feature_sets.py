...
Usage
-----
    PYTHONPATH=. python inference/compare_feature_sets.py \\
        --set legacy=inference/features/global_features.npz \\
        --set paper=inference/features/paper_features.npz
    PYTHONPATH=. python inference/compare_feature_sets.py --paired \\
        --set independent=inference/features/paper_features.npz \\
        --set shared=inference/features/shared_upp_paper_features.npz
"""
