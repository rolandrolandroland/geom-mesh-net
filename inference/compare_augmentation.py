...
Usage
-----
    PYTHONPATH=. python inference/compare_augmentation.py
    PYTHONPATH=. python inference/compare_augmentation.py --folds 5
"""
...
from inference.validate_posterior import (
    COVERAGE_LEVELS, ecdf_deviation, central_interval_coverage,
    kolmogorov_band, sbc_ranks,
)
