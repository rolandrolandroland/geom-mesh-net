...
``walkthroughs/clustersim_todo.md`` has asked "which features capture the most
...
Usage
-----
    PYTHONPATH=. python inference/ablate_features.py
    PYTHONPATH=. python inference/ablate_features.py --seeds 5
    PYTHONPATH=. python inference/ablate_features.py \\
        --features inference/features/global_features_cube_root.npz \\
        --label cube_root
"""
...
from inference.fit_posterior import (
    PRIOR_HIGH, PRIOR_LOW, load_stage1, split_indices,
)
